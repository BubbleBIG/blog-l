...
table{border:0}
#cal{width:320px;border:1px solid #fff;font-size:12px;margin:0px 0 0 0px}
#cal #top{height:29px;line-height:30px;background: #56ffdd;color:#003784;padding-left:16px}
#cal #top select{font-size:12px}
#cal #top input{padding:0;height: 30px}
#cal ul#wk{margin:0;padding:0;height:25px}
#cal ul#wk li{float:left;width:45px;text-align:center;line-height:20px;list-style:none}
...
#cal #cm .cell{position:absolute;width:57px;height:36px;text-align:center;margin:0 0 0 1px}
#cal #cm .cell .so{font:bold 15px arial;}
#cal #bm{text-align:right;height:5px;line-height:20px;padding:0 0px 0 0}
...
<![endif]-->
      <div id="cal">
        <div id="top">公元&nbsp;&nbsp;
          ...
          <input type="button" value="Today" title="点击后跳转回今天" style="padding:0px">
        </div>
        <ul id="wk">
          <li>一</li>
          <li>二</li>
...
var E="初十廿卅";
var V={
"0101":"*1元旦节","0214":"情人节","0305":"学雷锋纪念日","0308":"妇女节","0312":"植树节","0315":"消费者权益日","0401":"愚人节","0501":"*1劳动节","0504":"青年节","0601":"儿童节","0701":"中国共产党诞辰","0801":"建军节","0910":"中国教师节","1001":"*3国庆节","1224":"平安夜","1225":"圣诞节"
} ;
var T={
...
var Z=Q.getJson();
var c=Z.dateArray;
M("cm").style.height=Z.lines*36+2+"px";
M("cm").innerHTML="";
...
X.style.left=(a%7)*44+"px";
X.style.top=Math.floor(a/7)*35+2+"px";
var b=R("DIV");
b.className="so";
...
C.style.top=Z.offsetTop+Z.offsetHeight-20+"px";
C.style.left=Z.offsetLeft+Z.offsetWidth-20+"px";
